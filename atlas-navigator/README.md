...
- direction relative, cap cardinal, angle, distance et durée estimée ;
- tracé animé de l’itinéraire sur la carte ;
- évaluation du niveau de danger et signalement des territoires adverses ;
- centrage automatique sur la destination ;
- notification lorsque la destination est atteinte.

## Utilisation

1. Activez **Atlas Navigator — Carte universelle** dans le gestionnaire d’add-ons.
2. Recherchez un lieu ou cliquez sur une région de la carte.
3. Zoomez pour faire apparaître les quatre zones de chaque région.
